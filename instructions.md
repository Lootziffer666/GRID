...
Do create a claude.md perfectly fitting this project in root 
Do create and maintain a knownbugs.md and document every bug/problem you encounter for next iterations to learn from and avoid to make the same mistake twice in root.
Do create artifacts that follow the same structure only.
Do create a logical file system to avoid repo cluttering.
Do create and maintain a fully detailed readme.md in root.
Do create a template for future projects following theses guidelines.
